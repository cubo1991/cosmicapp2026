...
export default function CrearJugador() {
  const { crear, loading, error } = usePlayers();
  ...
  const handleSubmit = async (e) => {
    ...
    if (resultado.success) {
      setMensajeExito("¡Jugador creado exitosamente!");
      setFormData({ nombre: "", email: "", avatar: "" });
      setTimeout(() => setMensajeExito(""), 3000);
    } else {
      setMensajeError(resultado.error || "Error al crear jugador");
    }
  };

  return (
    <div className="w-full max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-bold mb-6 text-gray-800">Crear Jugador</h2>
